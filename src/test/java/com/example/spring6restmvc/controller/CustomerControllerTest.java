...
class CustomerControllerTest {
    ...
    void testPatchCustomer() throws Exception {
        ...
        mockMvc.perform(patch(CustomerController.CUSTOMER_PATH_ID, customerDto.getId()).with(httpBasic(BeerControllerTest.USERNAME, BeerControllerTest.PASSWORD))
    ...
    void testDeleteCustomer() throws Exception {
        ...
        mockMvc.perform(delete(CustomerController.CUSTOMER_PATH_ID, customerDto.getId()).with(httpBasic(BeerControllerTest.USERNAME, BeerControllerTest.PASSWORD))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent());
    ...
    void testUpdateCustomer() throws Exception {
        ...
        given(customerService.updateCustomerById(any(), any())).willReturn(Optional.of(CustomerDTO.builder()
                .build()));
        mockMvc.perform(put(CustomerController.CUSTOMER_PATH_ID, customerDto.getId()).with(httpBasic(BeerControllerTest.USERNAME, BeerControllerTest.PASSWORD))
    ...
    void testCreatCustomer() throws Exception {
        ...
        mockMvc.perform(post(CustomerController.CUSTOMER_PATH).contentType(MediaType.APPLICATION_JSON).with(httpBasic(BeerControllerTest.USERNAME, BeerControllerTest.PASSWORD))
                        .accept(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(customerDto)))
    ...
    void getCustomerById() throws Exception {
        ...
        mockMvc.perform(get(CustomerController.CUSTOMER_PATH_ID, customerDto.getId()).with(httpBasic(BeerControllerTest.USERNAME, BeerControllerTest.PASSWORD))
                        .accept(MediaType.APPLICATION_JSON))
